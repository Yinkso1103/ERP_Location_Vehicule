    ...
    <div class="row justify-content-center">
        <div class="col-md-7">
            ...
            <div class="d-flex justify-content-between align-items-center mb-3">
                <h2><i class="fas fa-file-csv text-primary"></i> Import CSV — Motos</h2>
            ...
            <div class="card shadow-sm mb-3">
                ...
                <div class="card-body">
                    ...
                    <code>marque, modele, prix, annee, couleur, cylindree, type_moto</code>
                    <div class="mt-3">
                        <a href="index.php?controller=vehicule&action=downloadTemplateMoto" class="btn btn-sm btn-outline-primary">
            ...
            <div class="card shadow-sm">
                <div class="card-body">
                    <form action="index.php?controller=vehicule&action=importProcessMoto" method="POST" enctype="multipart/form-data">
                        <div class="mb-3">
